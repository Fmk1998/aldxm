<?php
		...
		$num=$b['ppnum']-$f[0];
		$e="select sid,Name from studentdb,ptable where ptable.pid2=$pid and ptable.sid=studentdb.Id and pfid is null";//查找第二志愿选择该项目的信息
		$q=mysql_query($e,$con);
		$m="select sid,Name from studentdb,ptable where ptable.sid=studentdb.Id and pfid=$pid";//查找已确定为该项目的人
        $j=mysql_query($m,$con);
		$u="select * from studentdb,ptable where ptable.pid2=$pid and ptable.sid=studentdb.Id and pfid is null";//查找第二志愿选择该项目的人数且没有被选择的人
		$o=mysql_query($u,$con);
